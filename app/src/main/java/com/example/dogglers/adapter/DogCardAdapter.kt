...
class DogCardAdapter(
    ...
    override fun getItemCount(): Int =
        info.size // TODO: return the size of the data set instead of 0
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.textView2?.text = "age: ${item.age} "
        holder.textView3?.text = item.hobbies
